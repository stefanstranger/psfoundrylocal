...
```
src/
├── public/                      # Custom PowerShell functions (dot-sourced)
├── psfoundrylocal.crescendo.json  # Crescendo configuration
├── psfoundrylocal.psm1           # Generated module + custom code
├── psfoundrylocal.psd1           # Module manifest
├── psfoundrylocal.format.ps1xml  # Format definitions
└── outputhandlers.ps1            # Output handler functions
tests/
├── Integration.Tests.ps1         # Integration tests
└── OutputHandlers.Tests.ps1      # Unit tests for output handlers
```
